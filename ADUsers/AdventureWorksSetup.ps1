...
# Create Users
Import-Csv -Path .\AdventureWorksUsers.csv | ForEach-Object {New-ADUser -AccountPassword $SecurePWD -GivenName $_.FirstName -Surname $_.LastName -Name $_.DisplayName -DisplayName $_.Name -SamAccountName $_.FirstName -UserPrincipalName $_.UPN -Path $_.OU -PasswordNeverExpires $true -Enabled $true}
