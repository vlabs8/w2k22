...
Get-NetAdapter 
# Check for InterfaceIndex and set it in below commands accordingly "–InterfaceIndex #"
New-NetIPAddress –IPAddress 192.168.1.151 -DefaultGateway 192.168.1.1 -PrefixLength 24 -InterfaceIndex 2
Set-DNSClientServerAddress –InterfaceIndex 2 –ServerAddresses 192.168.1.150
...
Get-NetAdapter 
# Check for InterfaceIndex and set it in below commands accordingly "–InterfaceIndex #"
New-NetIPAddress –IPAddress 192.168.1.152 -DefaultGateway 192.168.1.1 -PrefixLength 24 -InterfaceIndex 14
Set-DNSClientServerAddress –InterfaceIndex 14 –ServerAddresses 192.168.1.150,127.0.0.1
...
Get-NetAdapter 
# Check for InterfaceIndex and set it in below commands accordingly "–InterfaceIndex #"
New-NetIPAddress –IPAddress 192.168.1.153 -DefaultGateway 192.168.1.1 -PrefixLength 24 -InterfaceIndex 6
Set-DNSClientServerAddress –InterfaceIndex 6 –ServerAddresses 192.168.1.150,127.0.0.1
